          ...
          <ActualPaddedSectionStyle>
            <div className="welcome">
              ...
              <div className="one txxt">
                ...
                viewport={{once : true }}
                >
                  <h3>Welcome to Binary’s E-learning Website</h3>
                  <p className="small">
                    In Binary, we guide you with the best available teaching and
        ...
        <div className="mobile">
          <ActualPaddedSectionStyle>
            <div className="welcome">
              ...
              whileInView="final"
              viewport={{once : true}}
              >Welcome to Binary’s E-learning Website</motion.h3>
              <Image
